...
class vendas extends model {
	...
	public function setVenda($uid, $endereco, $valor, $pg, $prods) {
		...
		*/
		...
		if($pg == '1') {
			$status = '2';
			$link = '/loja.pc/carrinho/obrigado';
			...
			$paymentRequest->setRedirectURL("http://loja.pc/index.php/carrinho/obrigado");
	...
	public function setVendaCkTransparente($params, $uid, $sessionId, $prods, $subtotal) {
		...
		*/
		...
		$directPaymentRequest->addParameter("notificationURL", "http://millamarykay.esy.es/carrinho/notificacao");
